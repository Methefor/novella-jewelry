...
export default function WhatsAppProductButton({
  ...
  const variantClasses = {
    ...
    outline:
      'bg-transparent hover:bg-green-50 text-green-600 border-green-500 hover:border-green-600',
    ghost:
      'bg-transparent hover:bg-green-100 text-green-600 border-transparent hover:border-green-200',
  };
